...
- Tools used: `nmap`, `gobuster`, `hydra`, `john` (and `ssh2john`), `ssh`  
...
<figure>
  ...
  <figcaption>Figure 2 — Service banners: SSH and Apache.</figcaption>
</figure>


### 3. Which Linux distribution is running?
<figure>
...
<figure>
  <img src="/assets/images/BruteIt/hidden-directories.png" alt="Gobuster results" style="max-width:33%; display:inline-block;">
   <figcaption>Figure 4 — Gobuster results</figcaption>
</figure>
...
* Inspecting page source revealed a username hint
...
<figure>
  ...
  <figcaption>Figure 5 — Admin page, and source with hint.</figcaption>
</figure>
...
### 1. What is the `user:password` for the admin panel?
`admin:xavier`
<figure>
  <img src="/assets/images/BruteIt/hydra-results-1.png" alt="Hydra output 1" style="max-width:48%; display:inline-block;">
    <figcaption>Figure 6 — Hydra output confirming credentials </figcaption>
</figure>

page source revealed `admin` as username; Hydra was used to brute-force the password.
...
<figure>
  ...
  <figcaption>Figure 7 — Admin panel login screenshot included.</figcaption>
</figure>

---

## 2. What is John's RSA Private Key passphrase?
...
<figure>
  ...
  <figcaption>Figure 8 — RSA private key link exposed in admin panel; copy and save locally as <code>id_rsa</code>.</figcaption>
</figure>
...
<figure>
  <img src="/assets/images/BruteIt/changing-rsaPkey-hash.png" alt="ssh2john conversion" style="max-width:48%; display:inline-block;">
   <figcaption>Figure 9 — Conversion to John format output.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Figure 10 — cracked passphrase output.</figcaption>
</figure>
